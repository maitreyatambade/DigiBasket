        ...
        <tr>
            <td>
                &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" 
                    PostBackUrl="~/adminlogin.aspx" style="text-align: right">Click Here For Admin Login</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" class="style2">
                    ...
                    <tr>
                        ...
                        &nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT * FROM [new_user]"></asp:SqlDataSource>
                        </td>
                    </tr>
                    <tr>
                        <td class="style3">
                    ...
                    <tr>
                        <td class="style3">
                            &nbsp;</td>
                        <td class="style4">
&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Forget_Password.aspx" 
                               >Fargot Password</asp:LinkButton>
                            &nbsp;
                            <asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/New_User.aspx">Create New User</asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </td>

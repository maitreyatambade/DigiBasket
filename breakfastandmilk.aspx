<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="breakfastandmilk.aspx.cs" Inherits="breakfastandmilk" %>
            ...
            <td>
                <table align="center" cellpadding="6" cellspacing="6" class="style25">
                    ...
                    SelectCommand="SELECT * FROM [ProductMst1] WHERE ([CatId] = @CatId)">
                                <SelectParameters>
                                    <asp:FormParameter DefaultValue="Milk &amp; Breakfast" 
                                        FormField="Milk &amp; Breakfast" Name="CatId" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
